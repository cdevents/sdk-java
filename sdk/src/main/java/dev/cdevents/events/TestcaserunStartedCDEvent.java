...
public class TestcaserunStartedCDEvent extends Testcaserunstarted implements CDEvent {
    ...
    /**
    * Constructor to init CDEvent and set the Subject for {@link TestcaserunStartedCDEvent}.
    */
    ...
    */
    ...
    /**
    * @return the testcaserunstarted.json schema URL
    */
    ...
    /**
    * @return the testcaserunstarted.json schema Json
    */

    @Override
    public String eventSchema() {
        try {
            return Files.readString(Paths.get(CDEventConstants.SCHEMA_FOLDER + "/testcaserunstarted.json"));
        } catch (IOException e) {
