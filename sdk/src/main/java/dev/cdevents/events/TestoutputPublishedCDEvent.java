...
public class TestoutputPublishedCDEvent extends Testoutputpublished implements CDEvent {
    ...
    /**
    * Constructor to init CDEvent and set the Subject for {@link TestoutputPublishedCDEvent}.
    */
    ...
    */
    ...
    public void initCDEvent() {
        ...
        getSubject().getContent().setTestCaseRun(new TestCaseRun());
        getSubject().setType(Subject.Type.TEST_OUTPUT);
    }
    ...
    */
    ...
    /**
    * @return the testoutputpublished.json schema URL
    */
    ...
    /**
    * @return the testoutputpublished.json schema Json
    */

    @Override
    public String eventSchema() {
        try {
            return Files.readString(Paths.get(CDEventConstants.SCHEMA_FOLDER + "/testoutputpublished.json"));
        } catch (IOException e) {
    ...
    */
    public void setSubjectOutputType(Content.OutputType outputType) {
        getSubject().getContent().setOutputType(outputType);
    }
    ...
    */
    public void setSubjectFormat(String format) {
        getSubject().getContent().setFormat(format);
    }
    ...
    */
    public void setSubjectTestCaseRunId(String id) {
        getSubject().getContent().getTestCaseRun().setId(id);
    }
    /**
    * @param source
    */
    public void setSubjectTestCaseRunSource(String source) {
        getSubject().getContent().getTestCaseRun().setSource(source);
    }
