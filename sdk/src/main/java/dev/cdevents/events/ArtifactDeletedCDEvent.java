...
public class ArtifactDeletedCDEvent extends Artifactdeleted implements CDEvent {
    ...
    /**
    * Constructor to init CDEvent and set the Subject for {@link ArtifactDeletedCDEvent}.
    */

    public ArtifactDeletedCDEvent() {
        initCDEvent();
    }
    ...
    */
    ...
    /**
    * @return the artifactdeleted.json schema URL
    */

    @Override
    public String schemaURL() {
        return "https://cdevents.dev/0.4.1/schema/artifact-deleted-event";
    }
