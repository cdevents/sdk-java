...
public class ArtifactDownloadedCDEvent extends Artifactdownloaded implements CDEvent {
    ...
    /**
    * Constructor to init CDEvent and set the Subject for {@link ArtifactDownloadedCDEvent}.
    */

    public ArtifactDownloadedCDEvent() {
        initCDEvent();
    }
    ...
    */
    ...
    /**
    * @return the artifactdownloaded.json schema URL
    */

    @Override
    public String schemaURL() {
        return "https://cdevents.dev/0.4.1/schema/artifact-downloaded-event";
    }
