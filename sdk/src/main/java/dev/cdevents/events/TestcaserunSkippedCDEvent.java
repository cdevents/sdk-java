...
public class TestcaserunSkippedCDEvent extends Testcaserunskipped implements CDEvent {
    ...
    /**
    * Constructor to init CDEvent and set the Subject for {@link TestcaserunSkippedCDEvent}.
    */

    public TestcaserunSkippedCDEvent() {
        initCDEvent();
    }
    ...
    */
    ...
    /**
    * @return the testcaserunskipped.json schema URL
    */

    @Override
    public String schemaURL() {
        return "https://cdevents.dev/0.4.1/schema/test-case-run-skipped-event";
    }
