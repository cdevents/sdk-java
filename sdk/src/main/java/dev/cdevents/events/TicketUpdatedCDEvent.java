...
public class TicketUpdatedCDEvent extends Ticketupdated implements CDEvent {
    ...
    /**
    * Constructor to init CDEvent and set the Subject for {@link TicketUpdatedCDEvent}.
    */

    public TicketUpdatedCDEvent() {
        initCDEvent();
    }
    ...
    */
    ...
    /**
    * @return the ticketupdated.json schema URL
    */

    @Override
    public String schemaURL() {
        return "https://cdevents.dev/0.4.1/schema/ticket-updated-event";
    }
