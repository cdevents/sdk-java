...
public class IncidentDetectedCDEvent extends Incidentdetected implements CDEvent {
    ...
    /**
    * Constructor to init CDEvent and set the Subject for {@link IncidentDetectedCDEvent}.
    */
    ...
    */
    ...
    /**
    * @return the incidentdetected.json schema URL
    */
    ...
    /**
    * @return the incidentdetected.json schema Json
    */

    @Override
    public String eventSchema() {
        try {
            return Files.readString(Paths.get(CDEventConstants.SCHEMA_FOLDER + "/incidentdetected.json"));
        } catch (IOException e) {
