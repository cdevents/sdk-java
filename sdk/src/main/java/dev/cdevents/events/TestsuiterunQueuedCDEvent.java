...
public class TestsuiterunQueuedCDEvent extends Testsuiterunqueued implements CDEvent {
    ...
    */
    ...
    public String schemaURL() {
        return "https://cdevents.dev/0.3.0/schema/test-suite-run-queued-event";
    }


    /**
    * @return the testsuiterunqueued.json schema Json
    */

    @Override
    public String eventSchema() {
        try {
            return Files.readString(Paths.get(CDEventConstants.SCHEMA_FOLDER + "/testsuiterunqueued.json"));
        } catch (IOException e) {
