...
public class IncidentReportedCDEvent extends Incidentreported implements CDEvent {
    ...
    /**
    * Constructor to init CDEvent and set the Subject for {@link IncidentReportedCDEvent}.
    */
    ...
    */
    ...
    /**
    * @return the incidentreported.json schema URL
    */
    ...
    */
    ...
    public String eventSchema() {
        try {
            return Files.readString(Paths.get(CDEventConstants.SCHEMA_FOLDER + "/incidentreported.json"));
        } catch (IOException e) {
    ...
    */
    public void setSubjectTicketURI(URI ticketURI) {
        getSubject().getContent().setTicketURI(ticketURI);
    }
