...
public class Context {
     ...
     */
    @JsonProperty("type")
    private Context.Type type = Context.Type.fromValue("dev.cdevents.repository.created.0.1.1");
    /**
     * 
     * (Required)
     * 
    ...
    public enum Type {
        ...
        DEV_CDEVENTS_REPOSITORY_CREATED_0_1_1("dev.cdevents.repository.created.0.1.1");
