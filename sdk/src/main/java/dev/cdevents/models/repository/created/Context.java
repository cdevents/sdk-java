...
public class Context {
     ...
     */
    @JsonProperty("type")
    private Context.Type type = Context.Type.fromValue("dev.cdevents.repository.created.0.2.0");
    /**
     * 
     * (Required)
     * 
    ...
    public enum Type {
        ...
        DEV_CDEVENTS_REPOSITORY_CREATED_0_2_0("dev.cdevents.repository.created.0.2.0");
