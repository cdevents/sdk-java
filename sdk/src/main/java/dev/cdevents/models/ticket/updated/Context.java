...
package dev.cdevents.models.ticket.updated;
...
public class Context {
     ...
     */
    @JsonProperty("type")
    private Context.Type type = Context.Type.fromValue("dev.cdevents.ticket.updated.0.1.0");
    /**
     * 
     * (Required)
     * 
    ...
    public enum Type {
        ...
        DEV_CDEVENTS_TICKET_UPDATED_0_1_0("dev.cdevents.ticket.updated.0.1.0");
