...
public class Context {
     ...
     */
    @JsonProperty("type")
    private Context.Type type = Context.Type.fromValue("dev.cdevents.change.reviewed.0.1.2");
    /**
     * 
     * (Required)
     * 
    ...
    public enum Type {
        ...
        DEV_CDEVENTS_CHANGE_REVIEWED_0_1_2("dev.cdevents.change.reviewed.0.1.2");
