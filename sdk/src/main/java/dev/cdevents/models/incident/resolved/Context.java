...
public class Context {
     ...
     */
    @JsonProperty("type")
    private Context.Type type = Context.Type.fromValue("dev.cdevents.incident.resolved.0.2.0");
    /**
     * 
     * (Required)
     * 
    ...
    public enum Type {
        ...
        DEV_CDEVENTS_INCIDENT_RESOLVED_0_2_0("dev.cdevents.incident.resolved.0.2.0");
