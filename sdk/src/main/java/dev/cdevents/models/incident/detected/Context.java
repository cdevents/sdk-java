...
public class Context {
     ...
     */
    @JsonProperty("type")
    private Context.Type type = Context.Type.fromValue("dev.cdevents.incident.detected.0.1.0");
    /**
     * 
     * (Required)
     * 
    ...
    public enum Type {
        ...
        DEV_CDEVENTS_INCIDENT_DETECTED_0_1_0("dev.cdevents.incident.detected.0.1.0");
