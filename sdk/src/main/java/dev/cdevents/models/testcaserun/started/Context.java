...
public class Context {
     ...
     */
    @JsonProperty("type")
    private Context.Type type = Context.Type.fromValue("dev.cdevents.testcaserun.started.0.2.0");
    /**
     * 
     * (Required)
     * 
    ...
    public enum Type {
        ...
        DEV_CDEVENTS_TESTCASERUN_STARTED_0_2_0("dev.cdevents.testcaserun.started.0.2.0");
