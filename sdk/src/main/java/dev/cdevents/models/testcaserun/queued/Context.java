...
public class Context {
     ...
     */
    @JsonProperty("type")
    private Context.Type type = Context.Type.fromValue("dev.cdevents.testcaserun.queued.0.1.0");
    /**
     * 
     * (Required)
     * 
    ...
    public enum Type {
        ...
        DEV_CDEVENTS_TESTCASERUN_QUEUED_0_1_0("dev.cdevents.testcaserun.queued.0.1.0");
