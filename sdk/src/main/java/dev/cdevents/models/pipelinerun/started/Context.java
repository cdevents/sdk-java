...
public class Context {
     ...
     */
    @JsonProperty("type")
    private Context.Type type = Context.Type.fromValue("dev.cdevents.pipelinerun.started.0.2.0");
    /**
     * 
     * (Required)
     * 
    ...
    public enum Type {
        ...
        DEV_CDEVENTS_PIPELINERUN_STARTED_0_2_0("dev.cdevents.pipelinerun.started.0.2.0");
