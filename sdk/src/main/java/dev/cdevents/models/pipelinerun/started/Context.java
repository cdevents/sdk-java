...
public class Context {
     ...
     */
    @JsonProperty("type")
    private Context.Type type = Context.Type.fromValue("dev.cdevents.pipelinerun.started.0.1.1");
    /**
     * 
     * (Required)
     * 
    ...
    public enum Type {
        ...
        DEV_CDEVENTS_PIPELINERUN_STARTED_0_1_1("dev.cdevents.pipelinerun.started.0.1.1");
