...
public class Context {
     ...
     */
    @JsonProperty("type")
    private Context.Type type = Context.Type.fromValue("dev.cdevents.pipelinerun.finished.0.1.1");
    /**
     * 
     * (Required)
     * 
    ...
    public enum Type {
        ...
        DEV_CDEVENTS_PIPELINERUN_FINISHED_0_1_1("dev.cdevents.pipelinerun.finished.0.1.1");
