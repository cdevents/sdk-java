...
public class Context {
     ...
     */
    @JsonProperty("type")
    private Context.Type type = Context.Type.fromValue("dev.cdevents.testsuiterun.finished.0.1.0");
    /**
     * 
     * (Required)
     * 
    ...
    public enum Type {
        ...
        DEV_CDEVENTS_TESTSUITERUN_FINISHED_0_1_0("dev.cdevents.testsuiterun.finished.0.1.0");
