...
public class Context {
     ...
     */
    @JsonProperty("type")
    private Context.Type type = Context.Type.fromValue("dev.cdevents.testsuiterun.finished.0.2.0");
    /**
     * 
     * (Required)
     * 
    ...
    public enum Type {
        ...
        DEV_CDEVENTS_TESTSUITERUN_FINISHED_0_2_0("dev.cdevents.testsuiterun.finished.0.2.0");
