...
public class Context {
     ...
     */
    @JsonProperty("type")
    private Context.Type type = Context.Type.fromValue("dev.cdevents.testsuiterun.started.0.1.0");
    /**
     * 
     * (Required)
     * 
    ...
    public enum Type {
        ...
        DEV_CDEVENTS_TESTSUITERUN_STARTED_0_1_0("dev.cdevents.testsuiterun.started.0.1.0");
