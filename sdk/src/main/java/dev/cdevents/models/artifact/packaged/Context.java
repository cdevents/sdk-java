...
public class Context {
     ...
     */
    @JsonProperty("type")
    private Context.Type type = Context.Type.fromValue("dev.cdevents.artifact.packaged.0.1.1");
    /**
     * 
     * (Required)
     * 
    ...
    public enum Type {
        ...
        DEV_CDEVENTS_ARTIFACT_PACKAGED_0_1_1("dev.cdevents.artifact.packaged.0.1.1");
