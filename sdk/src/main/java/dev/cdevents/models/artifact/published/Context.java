...
public class Context {
     ...
     */
    @JsonProperty("type")
    private Context.Type type = Context.Type.fromValue("dev.cdevents.artifact.published.0.2.0");
    /**
     * 
     * (Required)
     * 
    ...
    public enum Type {
        ...
        DEV_CDEVENTS_ARTIFACT_PUBLISHED_0_2_0("dev.cdevents.artifact.published.0.2.0");
