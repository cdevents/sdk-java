...
public class Context {
     ...
     */
    @JsonProperty("type")
    private Context.Type type = Context.Type.fromValue("dev.cdevents.artifact.published.0.1.1");
    /**
     * 
     * (Required)
     * 
    ...
    public enum Type {
        ...
        DEV_CDEVENTS_ARTIFACT_PUBLISHED_0_1_1("dev.cdevents.artifact.published.0.1.1");
